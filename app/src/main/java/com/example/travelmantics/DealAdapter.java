...
public class DealAdapter extends RecyclerView.Adapter<DealAdapter.DealViewHolder> {
    ...
    private ImageView imageRv;

    public DealAdapter(){
        //        Firebase database access to "travelDeals" path
//        FirebaseUtil.openFbReference("travelDeals");
        ...
        mChildListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                Log.d("Deal", "onChildAdded: " + td.getTitle());
    ...
    public class DealViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            Log.d("Click", "onClick: " + /*String.valueOf(position)*/ position );
        ...
        private void showImage(String url){
            if (url != null && url.isEmpty() == false) {
                Picasso.get().load(url).resize(240, 240).centerCrop().into(imageRv);
            }
        }
    }
}
